...
export function SignInForm() {
  return (
    <div className="w-full max-w-sm">
      <div className="border-border/60 bg-card/60 rounded-2xl border p-8 backdrop-blur">
        <div className="mb-7 flex flex-col gap-2 text-center">
          <h1 className="text-2xl font-medium tracking-tight">
            Sign In To <span className="text-orange-500">Peep</span>
          </h1>
        ...
        <p className="text-muted-foreground/70 mt-7 text-center text-xs text-balance">
...
function ProviderButton({
  ...
  return (
    <button
      ...
      onClick={onClick}
      className={cn(
        "border-border/70 bg-background/40 hover:bg-muted/60 hover:border-border",
        "inline-flex w-full items-center justify-center gap-3 rounded-lg border px-4 py-2.5",
        "text-sm font-medium transition-colors focus-visible:ring-2 focus-visible:ring-orange-500/40 focus-visible:outline-none",
      )}
    >
